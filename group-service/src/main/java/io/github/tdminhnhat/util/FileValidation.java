...
public class FileValidation {
    ...
    public static boolean validateImageFileExtension(CompletedFileUpload file) {
        MediaType mediaType = file.getContentType().orElseThrow(() -> new FileExtensionException("File must have content type"));
